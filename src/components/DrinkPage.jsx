...
const DrinkPage = () => {
  return (
    <>
      <div className="flex flex-col h-full w-[300px] h-[500px]">
        <h1 className="font-noto text-lg justify-center text-center">
          Hydrate Daily!
        </h1>
        <h2 className="font-noto text-sm text-left p-0 m-0">Today</h2>
    ...
    text-[#ffffff] bg-[#55BCD8] rounded-lg px-4 py-2
